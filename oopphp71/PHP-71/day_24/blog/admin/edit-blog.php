                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="category_name" class="form-control">
                                    ...
                                    <option value="1" <?php if ($blogInfo['category_name'] =='1') echo "selected";?>>Category One</option>
                                    <option value="2" <?php if ($blogInfo['category_name'] =='2') echo "selected";?>>category Two</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
