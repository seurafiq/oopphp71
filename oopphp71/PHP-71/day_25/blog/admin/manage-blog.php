            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        while ($categoryResult = mysqli_fetch_assoc($queryResult)) { ?>
                        <tbody>
                        <tr>
                            <th scope="row"><?php echo $i++; ?></th>
                            <td><?php echo $categoryResult['category_name'] ?></td>
                            <td><?php echo $categoryResult['blog_title'] ?></td>
                            <td><?php echo $categoryResult['status'] ==1 ? 'published': 'unpublished' ?></td>
                            <td>
                                <a href="particular-view-blog.php?id=<?php echo $categoryResult['id'] ?>">View</a>
